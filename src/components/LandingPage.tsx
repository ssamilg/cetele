...
const FEATURES = [
  { icon: "⚡", label: "Real-time timer" },
  { icon: "☁️", label: "Google Sheets sync" },
  { icon: "💰", label: "Earnings tracker" },
  { icon: "📊", label: "Daily analytics" },
]

const headlineWords = ["Master", "Your", "Time."]
    ...
    <div className="relative min-h-svh bg-[#060912] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl w-full">
        ...
        >
          ...
          <br />
          <span className="text-slate-500">No clutter. No noise. Just focus.</span>
        </motion.p>
